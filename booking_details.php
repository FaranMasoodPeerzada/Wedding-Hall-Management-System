...
if (isset($_GET['booking_id'])) {
    ...
    if ($booking_result->num_rows > 0) {
        ...
        echo "<tr><td colspan='2'></td><td>Total Amount Paid:</td><td>{$booking_row['paid_amount']}</td></tr>";
        

        echo "<tr><td colspan='2'></td><td>Remaining Balance:</td><td>{$booking_row['remaining_balance']}</td></tr>";
