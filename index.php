...
<body class="scroll-bar">
   ...
   <header>
      <div class="header-container">
         <nav class="header-nav-bar">
				...
				<ul class="header-nav-lists">
						...
						<li class="header-nav-list"><a class="header-btn header-btn-custom" href="signuppage.php">SIGNUP</a></li>
					</ul>
	...
	<div class="jumbotron-container">
		...
		<form method="post" action="login.php" class="jumbotron-form">
				<!-- Put the form here -->
				<h3>Login to Your Account</h3><br>
					...
					<p> New User ? <a href="./signuppage.php" > Signup</a>
			</form>
